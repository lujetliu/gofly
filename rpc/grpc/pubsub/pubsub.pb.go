...
var file_pubsub_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x32, 0x60, 0x0a, 0x0d, 0x50, 0x75, 0x62, 0x73, 0x75, 0x62, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x24, 0x0a, 0x06, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x12,
	...
	0x72, 0x69, 0x6e, 0x67, 0x30, 0x01, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_pubsub_proto_depIdxs = []int32{
	0, // 0: main.PubsubService.Public:input_type -> main.String
	0, // 1: main.PubsubService.Subscribe:input_type -> main.String
	0, // 2: main.PubsubService.Public:output_type -> main.String
...
type PubsubServiceClient interface {
	Public(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error)
...
func (c *pubsubServiceClient) Public(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/main.PubsubService/Public", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PubsubServiceServer interface {
	Public(context.Context, *String) (*String, error)
...
func (*UnimplementedPubsubServiceServer) Public(context.Context, *String) (*String, error) {
...
func _PubsubService_Public_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(String)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PubsubServiceServer).Public(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.PubsubService/Public",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PubsubServiceServer).Public(ctx, req.(*String))
	}
...
var _PubsubService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Public",
			Handler:    _PubsubService_Public_Handler,
		},
	},
